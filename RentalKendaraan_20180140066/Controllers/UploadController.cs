...
using RentalKendaraan_20180140066.Models.Upload;
using System;
...
namespace RentalKendaraan_20180140066.Controllers
{
    public class UploadController : Controller
    {
        ...
        public async Task<IActionResult> UploadFile(IFormFile file)
        {
            ...
            var path = Path.Combine(Directory.GetCurrentDirectory(), "wwroot", file.GetFilename());
        ...
        public async Task<IActionResult> UploadFileViaModel(FileInputModel model)
        {
            if (model == null || model.FileToUpload == null || model.FileToUpload.Length == 0)
                return Content("File not selectcd");
